        ...
        <ScrollView>
          ...
          <KeyboardAvoidingView>
            ...
            <View style={styles.activityContainer}>
              ...
              <TextInput
                style={[styles.textinput, { marginLeft: 78 }]}
                placeholder={'Time spent in min'}
                placeholderTextColor="#000"
                keyboardType={'numeric'}
                onChangeText={(text) => {
            ...
            <View style={styles.activityContainer}>
              ...
              <TextInput
                style={[styles.textinput, { marginLeft: 53 }]}
                placeholder={'Time spent in min'}
                placeholderTextColor="#000"
                keyboardType={'numeric'}
                onChangeText={(text) => {
            ...
            <View style={styles.activityContainer}>
              ...
              <TextInput
                style={[styles.textinput, { marginLeft: 75 }]}
                placeholder={'Time spent in min'}
                keyboardType={'numeric'}
                placeholderTextColor="#000"
                onChangeText={(text) => {
            ...
            <View style={styles.activityContainer}>
              <Text style={styles.requiredText}>School Work</Text>
              <TextInput
                style={[styles.textinput, { marginLeft: 56 }]}
                placeholder={'Time spent in min'}
                keyboardType={'numeric'}
                placeholderTextColor="#000"
                onChangeText={(text) => {
            ...
            <View style={styles.activityContainer}>
              ...
              <TextInput
                style={[styles.textinput, { marginLeft: 89 }]}
                placeholder={'Time spent in min'}
                placeholderTextColor="#000"
                keyboardType={'numeric'}
                onChangeText={(text) => {
            ...
            <View style={styles.activityContainer}>
              ...
              <TextInput
                style={[styles.textinput, { marginLeft: 92 }]}
                placeholder={'Time spent in min'}
                keyboardType={'numeric'}
                placeholderTextColor="#000"
                onChangeText={(text) => {
            ...
            <View style={styles.activityContainer}>
              ...
              <TextInput
                style={[styles.textinput, { marginLeft: 101 }]}
                placeholder={'Time spent in min'}
                placeholderTextColor="#000"
                keyboardType={'numeric'}
                onChangeText={(text) => {
