    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          {}
           <Image style={{height: 40, alignItems:'center'}} source={"../assets/logo.jpg"} />
          <Text style={styles.title}>Time Waste</Text>
          <Text
            style={{
              color: '#000099',
              fontSize: 20,
        ...
        <View style={styles.buttonContainer}>
          ...
          <View style={{ alignItems: 'center' }}>
            <TouchableOpacity
              ...
              <Text
                style={{ color: '#000099', fontSize: 19, fontWeight: 'bold' }}>
                LOGIN
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
